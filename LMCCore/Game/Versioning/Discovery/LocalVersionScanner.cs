    ...
    Logger logger)
{
    ...
    public async Task<LocalGameVersionEntry?> CreateVersionEntryAsync(
        string rootPath,
        string versionDirectory,
        CancellationToken cancellationToken,
        bool resolveClientVersion = true)
    {
        ...
        var modLoaders = versionInfo == null
            ? []
            : LocalGameModLoaderResolver.Resolve(versionInfo, clientVersionId);
        return CreateEntry(rootPath, versionName, versionDirectory, hasJar ? jarPath : null, jsonPath, clientVersionId, versionInfo, modLoaders, status);
    }
    ...
    private static LocalGameVersionEntry CreateEntry(
        ...
        IReadOnlyList<LocalGameModLoader> modLoaders,
