...
public sealed class ForgeInstallationTaskProvider : ModLoaderInstallationTaskProvider
{
    ...
    public override void AddTasks(DownloadInstallationContext context)
    {
        ...
        throw new NotSupportedException(
            $"Forge task planning has not been implemented yet. Add Forge subtasks in {nameof(ForgeInstallationTaskProvider)} for loader version '{loader.VersionId}'.");
    }
}
