...
public sealed class OptiFineInstallationTaskProvider : IGameInstallationTaskProvider
{
    ...
    public void AddTasks(DownloadInstallationContext context)
    {
        ...
        throw new NotSupportedException(
            $"OptiFine task planning has not been implemented yet. Add OptiFine subtasks in {nameof(OptiFineInstallationTaskProvider)} for patch '{context.Request.OptiFine}'.");
    }
}
