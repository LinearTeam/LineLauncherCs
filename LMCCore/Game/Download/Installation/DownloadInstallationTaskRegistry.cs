...
public sealed class DownloadInstallationTaskRegistry
{
    ...
    public SubTask<List<DownloadableFileInfo>>? ForgeLibrariesTask { get; private set; }
    ...
    public void SetForgeLibrariesTask(SubTask<List<DownloadableFileInfo>> task)
    {
        ForgeLibrariesTask = task ?? throw new ArgumentNullException(nameof(task));
    }
    ...
    public IReadOnlyList<SubTaskBase> GetAllTasks()
    {
        ...
        AddTask(tasks, taskIds, ForgeLibrariesTask);
