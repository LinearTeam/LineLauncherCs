...
public class CommandBuilder
{
    ...
    public void AddJvmArgument(string arg)
    {
        ...
        // Long JVM options such as --add-opens and --add-exports are emitted
        // as a flag followed by its value. Multiple occurrences of the same
        // flag are valid and must remain paired with their respective values.
        // Treating the flag as a deduplicated scalar removes the first flag
        // while leaving its value orphaned (the JVM then interprets that value
        // as the main class, e.g. java.base/java.util.jar=...).
